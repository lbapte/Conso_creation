  ...
  useFocusEffect(
    React.useCallback(() => {
      const loadHistorique = async () => {
        try {
          const historique = await getHistoriqueByEanAndType(
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.Body}>
        ...
        >
          {selectedEan && (
            <ModalPage barcode={selectedEan} onClose={closeModal} />
          )}
        </Modal>
